...
class DownloadImagesFromPdf(Resource):
    def get(self):
...
api.add_resource(DownloadImagesFromPdf, '/downloadImagesFromPdf')
...
#http://localhost:5000/downloadImagesFromPdf?pdf_url=Cloundinary_URL